...
#tg-comp #tg-foot-sec{max-width:920px;margin:34px auto 0;text-align:center;}
#tg-comp .tg-trasp{font-size:14px;color:rgba(255,255,255,.85);line-height:1.6;margin-bottom:12px;}
#tg-comp .tg-nota{font-size:12px;color:rgba(255,255,255,.55);line-height:1.5;border-top:1px solid rgba(255,255,255,.12);padding-top:12px;}
...
function init(){
 try{
  ...
  var data=[
   ...
   {n:"Revolut",d:"revolut.com",k:"wallet",r:"40€",v:"variabile",e:DOC,u:"",s:["Registrati come nuovo cliente con il link","Aggiungi fondi (carta o bonifico)","Ordina la carta fisica","Fai gli acquisti minimi richiesti e ricevi il bonus"]},
   {n:"N26",d:"n26.com",k:"wallet",r:"5€",v:"5€",e:DOC,u:"",s:["Registrati a N26 con il nostro link","Apri e verifica il conto","Fai il primo pagamento con la carta (no PayPal) ≥ valore bonus","Ricevi il bonus (entro 60 giorni)"]},
   ...
   {n:"Tinaba",d:"tinaba.com",k:"wallet",r:"10€",v:"20€",e:DOC,u:"",s:["Scarica l'app e registrati con il codice","Completa l'attivazione (prima registrazione)","Ricarica il wallet di almeno 20€ entro 30 giorni","Ricevi il bonus"]},
   {n:"RedotPay",d:"redotpay.com",k:"wallet",c:"Wallet & app · crypto",r:"bonus USDT",v:"commissioni USDT",e:DOC,u:"https://wap.redotpay.com/en/invite/?referralId=p8ph9",s:["Registrati a RedotPay con il nostro link (codice in registrazione)","Completa la verifica identità (KYC)","Ordina e attiva la carta RedotPay","Inizia a spendere: ricevi le ricompense in USDT"]},
